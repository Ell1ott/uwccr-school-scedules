...
import { usePalette } from "@shared/lib/palette";
import { subjectKey, type SubjectKey } from "@shared/lib/tones";
...
export function EventIcon({
  ...
  return <Icon size={size} strokeWidth={1.75} color={color} {...props} />;
}
...
export function LessonMark({
  ...
  return <LessonIcon subject={subject} size={size} color={color} />;
}
